...
namespace BBG.Items
{
    ...
    public abstract class ItemEffect
    {
        ...
        private static ItemEffect BindEffect(string pathName, object[] parameters)
        {
            ...
            var v = asm.GetType("BBG.Data.ItemEffects." + pathName);
            //Debug.Log(v);

            Assert.IsNotNull(v, "Error trying to load ItemEffect: " + pathName + ", tried to load it from: " + "BBG.Data.ItemEffects." + pathName);
