...
namespace BBG
{
    ...
    public static class EnemyManager
    {
        ...
        public static void KillEnemy(Actor.Actor actor)
        {
        ...
        public static void SpawnEnemy(GameObject enemy, int x, int y, int rank, bool InitializeStartEffects = true)
        {
            ...
            Actor.Actor actorBehaviour = newEnemy.GetComponent<Actor.Actor>();
            ...
            {
                EventManager.Notify(Events.PostEnemySpawned, actorBehaviour);
        ...
        {
            Actor.Actor actor = GridManager.TileMap.GetAt(x, y);
            if (actor != null)
            {
        ...
        private static GameObject RollEnemy(EnemySpawnList spawnList, int x, int y)
        {
            ...
            UnityEngine.Debug.LogError("Something went wrong with spawning. No enemy was chosen for some reason");
